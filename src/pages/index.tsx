  ...
  return (
    <div className="w-full">
      ...
      <div className="bg-[url('/images/banner4.png')] lg:w-full w-auto h-[100vh] lg:h-[120vh] lg:-mt-20 mt-[70px] lg:pt-[200px] pt-20">
        <h2 className="text-4xl font-semibold lg:mx-[50px] mx-[20px] lg:w-[450px] w-full">
          Solusi Dana Tunai Cepat dengan Jaminan BPKB.
        </h2>
        <p className="text-xl lg:mx-[50px] mx-[20px] lg:mt-4 mt-2 lg:w-[500px] w-full">
        ...
        <button className="bg-blue-500 text-white py-2 px-4 rounded lg:mx-[50px] mx-[20px] lg:mt-4 mt-2 hover:bg-blue-600 duration-200">
          Ajukan Sekarang
        </button>
      </div>
      {/* Section 2 */}
      ...
      {/* Section 3 */}
      <div className="bg-gray-200 w-full h-[100vh] lg:px-10 px-4 lg:py-10 py-4 flex flex-col gap-2 justify-center items-center relative">
        <h2 className={`${poppinsBold} text-black text-4xl text-center`}>
          Mengapa Leasfund ?
        </h2>
        <div className="flex gap-4 mt-5">
          <div className="border-green-300 h-[50vh] w-[250px] bg-green-200 hover:-mt-2 mt-0 duration-300 transition-all shadow p-2 rounded lg:px-10 lg:py-5 cursor-pointer">
          ...
          <div className="border-blue-300 h-[50vh] w-[250px] bg-blue-200 hover:-mt-2 mt-0 duration-300 transition-all shadow p-2 rounded lg:px-10 lg:py-5 cursor-pointer">
            <h2 className="text-gray-700 text-xl">
              Semua data diproses secara online
            </h2>
            <p className="text-gray-700 mt-2">
          ...
          <div className="border-orange-300 h-[50vh] w-[250px] bg-orange-200 hover:-mt-2 mt-0 duration-300 transition-all shadow p-2 rounded lg:px-10 lg:py-5 cursor-pointer">
            <h2 className="text-gray-700 text-xl">
              Semua data diproses secara online
            </h2>
            <p className="text-gray-700 mt-2">
          ...
          <div className="border-red-300 h-[50vh] w-[250px] bg-red-200 hover:-mt-2 mt-0 duration-300 transition-all shadow p-2 rounded lg:px-10 lg:py-5 cursor-pointer">
            <h2 className="text-gray-700 text-xl">
              Semua data diproses secara online
            </h2>
            <p className="text-gray-700 mt-2">
      ...
      <div className="bg-white w-full lg:px-10 px-4 lg:py-10 py-4 flex flex-col gap-2 justify-center items-center relative">
        ...
        <div className="w-full flex gap-2 justify-center items-center">
          <img
            ...
            alt="logo"
            className="w-[100px] h-auto animate-runLoop"
          />
          <img
            src="/images/logo_full2.png"
            alt="logo"
