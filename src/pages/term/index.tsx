  ...
  return (
    <div>
      ...
      <div className="bg-green-200 h-[30vh] w-full flex justify-center items-center">
        <h1 className={`${poppinsBold} text-black font-bold text-3xl mt-14`}>
          Ketentuan Pengguna
        </h1>
      </div>
      <div className="bg-white w-full p-2 py-10">
        ...
        <p className="text-black text-justify mt-2">
          ...
          <br />
          Registrasi: Anda diwajibkan untuk memberikan informasi yang akurat dan
          lengkap saat mendaftar dan bertanggung jawab atas informasi tersebut.
          <br />
          ...
          <br />
          Persetujuan Transaksi: Dengan menggunakan layanan ini, Anda menyetujui
          semua transaksi finansial yang dilakukan melalui aplikasi dan
          bertanggung jawab sepenuhnya atas transaksi tersebut.
        </p>
        <p className="text-black text-justify mt-2">
        ...
        <p className="text-black text-justify mt-2">
          ...
          tanpa pemberitahuan terlebih dahulu. Leasfund juga berhak menolak atau
          membatasi akses pengguna yang melanggar Syarat dan Ketentuan ini.
        </p>
        <p className="text-black text-justify mt-2">
        ...
        <p className="text-black text-justify mt-2">
          ...
          <br />
          Perlindungan Data: Leasfund berkomitmen untuk melindungi privasi Anda
        ...
        <p className="text-black text-justify mt-2">
          ...
          hukum yang berlaku di Indonesia. Setiap perselisihan yang timbul akan
          diselesaikan melalui mediasi terlebih dahulu. Jika tidak berhasil,
          perselisihan akan diselesaikan melalui pengadilan.
        </p>
        <p className="text-black text-justify mt-2">
          10. Kontak Untuk pertanyaan atau keluhan terkait Syarat dan Ketentuan
          ini, silakan hubungi layanan pelanggan melalui aplikasi Leasfund.
        </p>
      </div>
      <BottomNav />
    </div>
